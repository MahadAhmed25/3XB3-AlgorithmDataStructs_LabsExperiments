...
def experiment5(numberOfRuns, numberOfElements, swaps):
    ...
    for i in range(numberOfRuns):
        swapped_list = create_near_sorted_list(
            numberOfElements, max_value, swaps)
        start = timeit.default_timer()
...
def experiment6(numberOfRuns, listLength):
    ...
    print("Quick Sort -- length:", listLength,
          " runs:", numberOfRuns, " time:", x1, "sec")
    print("Dual Pivot Quick Sort -- length:", listLength,
          " runs:", numberOfRuns, " time:", x2, "sec")
    print("=================================================================")
...
def graph_and_run_experiment6():
    ...
    q1, dq1 = experiment6(10, 10)
    q2, dq2 = experiment6(10, 50)
    q3, dq3 = experiment6(10, 100)
    q4, dq4 = experiment6(10, 500)
    q5, dq5 = experiment6(10, 1000)
    ...
    plt.plot(x, q, label="traditional quick sort")
    plt.plot(x, dq, label="dual pivot quick sort")

    ax.set_ylabel('Time (seconds)')
    ax.set_xlabel('Length of List')
    ax.legend()
    ax.set_title(
        'List length vs Time Comparing Traditional Quick Sort and Dual Pivot Quick Sort for 10 Runs')
...
def graph_and_run_experiment7():
    ...
    ax.legend()
    ax.set_title(
        'List length vs Time Comparing Merge sort vs Iterative Merge Sort for 10 Runs')
...
def experiment8(numberOfRuns, numberOfElements):
    ...
    print("Insertion sort -- listLength: ",
          numberOfElements, " time: ", x1, "sec")
    print("Merge sort -- listLength: ", numberOfElements, " time: ", x2, "sec")
...
def graph_and_run_experiment8():
    ...
    ax.legend()
    ax.set_title(
        'List length vs Time Displaying for 100 runs of "Good Sort vs Bad Sort"')
